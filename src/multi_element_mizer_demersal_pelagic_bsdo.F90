...
!
! !INTERFACE:
module mizer_multi_element_dem_pelagic_population
...
! !PUBLIC DERIVED TYPES:
   type,extends(type_particle_model),public :: type_multi_element_dem_pelagic_population
   ...
   end type type_multi_element_dem_pelagic_population
...
!
! !INPUT PARAMETERS:
   class (type_multi_element_dem_pelagic_population), intent(inout),target :: self
...
!EOC
   ...
   subroutine after_coupling(self)
      class (type_multi_element_dem_pelagic_population),intent(inout) :: self
   ...
   subroutine do_bottom(self,_ARGUMENTS_DO_BOTTOM_)
      class (type_multi_element_dem_pelagic_population),intent(in) :: self
...
end module mizer_multi_element_dem_pelagic_population
